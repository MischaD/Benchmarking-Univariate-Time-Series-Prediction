...
#PBS -N trafo
#PBS -M mischa.dombrowski@fau.de -m abe
...
seq_lengths="512"
delay_lengths_train="0,16,32,48,64,80,112,128,144,160,176"
delay_lengths_val="0,16,32,48,64,80,112,128,144,160,176"
delay_lengths_test="0,16,32,48,64,80,96,112,128,144,160,176"
sigmas="2"
period_lengths="32"
...
python ./src/data/make_dataset.py --sample_sequence_lengths=$seq_lengths --sigmas=$sigmas --delay_lengths=$delay_lengths_train --period_lengths=$period_lengths --sampling_strategy=$sampling_strategy_train --sample_size=$sampling_size_train ${base_dir}/data/train.pkl
python ./src/data/make_dataset.py --sample_sequence_lengths=$seq_lengths --sigmas=$sigmas --delay_lengths=$delay_lengths_val   --period_lengths=$period_lengths --sampling_strategy=$sampling_strategy_val   --sample_size=$sampling_size_val   ${base_dir}/data/val.pkl
python ./src/data/make_dataset.py --sample_sequence_lengths=$seq_lengths --sigmas=$sigmas --delay_lengths=$delay_lengths_test  --period_lengths=$period_lengths --sampling_strategy=$sampling_strategy_test  --sample_size=$sampling_size_test  ${base_dir}/data/test.pkl
